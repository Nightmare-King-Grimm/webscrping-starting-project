"""
Created on Wed Sep 22 13:25:34 2021
...
class ItemLoader:
    ...
    def add_value(self, field_name, value, *processors, **kw):
        ...
        if value is None:
            return
        if not field_name:
            for k, v_5 in value.items():
                self._add_value(k, v_5)
        else:
    ...
    def get_output_value(self, field_name):
        ...
        try:
            ...
            raise ValueError("Error with output processor: field=%r value=%r error='%s: %s'" %
                             (field_name, value, type(e_f).__name__, str(e_f)))
        ...
        try:
            ...
            raise ValueError(
                ...
                "error='%s: %s'" % (_proc.__class__.__name__, field_name,
                                    value, type(e_f).__name__, str(e_f)))
